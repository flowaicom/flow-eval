...
from flow_eval.lm.models.adapters.baseten.adapter import AsyncBasetenAPIAdapter, BasetenAPIAdapter
...
@patch("flow_eval.lm.models.adapters.baseten.adapter.OpenAI")
...
@patch("flow_eval.lm.models.adapters.baseten.adapter.BasetenAPIAdapter._make_request")
...
@patch("flow_eval.lm.models.adapters.baseten.webhook.ensure_baseten_webhook_secret")
...
@patch("flow_eval.lm.models.adapters.baseten.adapter.AsyncBasetenAPIAdapter._make_request")
@patch("flow_eval.lm.models.adapters.baseten.adapter.AsyncBasetenAPIAdapter._fetch_stream")
